 ...
 * @LastEditTime: 2021-09-17 09:35:20
 * @LastEditors: 码上talk|RC
 * @Description:
 * @FilePath: /web-admin/src/mixins/type/info.js
 * @微信:  13680065830
...
const typeInfo = {
  ...
  methods: {
    _boot () {
      ...
      return model.collection[entity].sendApi(action, { params: Object.assign({}, params), data: { dataType: 2, query: { id: Number(this.params.id) } } }).then(res => {
