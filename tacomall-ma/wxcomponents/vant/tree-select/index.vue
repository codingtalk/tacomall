...
<uni-shadow-root class="vant-tree-select-index"><view class="van-tree-select" :style="'height: '+(utils.addUnit(height))">
  ...
  <scroll-view scroll-y class="van-tree-select__content" :show-scrollbar="showScrollbar" :scroll-top="scrollTop" lower-threshold="80" @scrolltolower="scrolltolower" @scroll="scroll">
